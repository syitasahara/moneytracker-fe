            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="flex mb-8 gap-2">
                <button
                  ...
                  className={`flex-1 py-3 px-4 text-center font-medium rounded-lg border ${
              ...
              <div className="flex space-x-4 mt-10 pt-6 border-t border-gray-200">
                <button
                  ...
                  className="flex-grow bg-[#3B82F6] hover:bg-blue-700 text-white py-3 px-4 rounded-lg font-medium transition duration-200"
                >
                  Simpan Transaksi
                </button>
                <button
                  ...
                  className="flex-row bg-gray-100 hover:bg-gray-200 text-gray-700 py-3 px-4 rounded-lg font-medium transition duration-200 border border-gray-300"
                >
                  Batal
                </button>
              </div>
